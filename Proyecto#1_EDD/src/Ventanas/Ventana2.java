...
public class Ventana2 extends javax.swing.JFrame {
     ...
     */
    public Ventana2(Grafo y) {
        grafito = y;
        initComponents();
        this.setVisible(true);
        this.usuarios.setText(grafito.print());
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 130, 370, 250));

        jLabel1.setBackground(new java.awt.Color(0, 0, 0));
        jLabel1.setForeground(new java.awt.Color(244, 244, 244));
        jLabel1.setText("Usuarios Registrados");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 80, 130, 30));
        ...
        jPanel1.add(cerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 20, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana2(grafito).setVisible(true);
            }
        });
    }
